            ...
            <div class="box">
                <div class="box-header with-border">
                    <div class="pull-left btn-group">
                        ...
                        <?= $form->field($modelImport, 'file_goods')->fileInput(['accept' => "csv"])->label('Товары') ?>
                        <?= $form->field($modelImport, 'file_persons')->fileInput(['accept' => "csv"])->label('Покупатели') ?>
                        <?= Html::submitButton('Загрузить данные', ['class' => 'btn btn-flat btn-info']) ?>
                        <?php ActiveForm::end(); ?>
                    </div>
                </div>
