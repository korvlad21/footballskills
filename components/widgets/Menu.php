...
class Menu extends \yii\widgets\Menu
{
     ...
     * @inheritdoc
     */
    public $linkTemplate = '<a href="{url}">{icon} {label} <span class="label label-warning pull-right">{countNew}</span><span class="label label-primary pull-right">{countAll}</span></a>';
    /**
     * @inheritdoc
    ...
    {
        if (isset($item['items'])) {
            $labelTemplate = '<a href="{url}">{icon} {label} <span class="pull-right-container"></span></a>';
            $linkTemplate = '<a href="{url}">{icon} {label} <span class="pull-right-container"></span></a>';
        } else {
        ...
        $replacements = [
            ...
            '{countAll}' => isset($item['countAll']) ? $item['countAll'] : '',
            '{countNew}' => isset($item['countNew']) ? $item['countNew'] : '',
        ];
